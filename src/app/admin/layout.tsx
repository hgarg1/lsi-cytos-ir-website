...
export default async function AdminLayout({
  ...
  const navItems = [
    { label: 'System Overview', href: '/admin', icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
    { label: 'Document Vault', href: '/admin/documents', icon: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-6l-2-2H5a2 2 0 00-2 2z' },
    { label: 'User Directory', href: '/admin/users', icon: 'M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z' },
    { label: 'Security Protocols', href: '/admin/security', icon: 'M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z' },
    { label: 'Audit Engine', href: '/admin/logs', icon: 'M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z' },
  ];
      ...
      <header className="h-16 border-b border-white/[0.03] bg-[#0F1216]/80 backdrop-blur-xl flex items-center justify-between px-8 sticky top-0 z-50">
        <div className="flex items-center gap-8">
          <Link href="/ir" className="flex items-center gap-2.5 group">
            ...
            <span className="text-sm font-bold tracking-tight text-white/90">COMMAND_CENTER</span>
          </Link>
          <div className="flex items-center gap-2 bg-white/[0.03] px-3 py-1 rounded-full border border-white/[0.05]">
             <div className="w-1.5 h-1.5 rounded-full bg-evergreen animate-pulse"></div>
             <span className="text-[10px] font-mono text-gray-400 uppercase tracking-widest">System Operational</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-6">
           ...
           <Link href="/ir" className="text-xs font-medium text-gray-400 hover:text-white transition-colors flex items-center gap-2">
             <span>Exit</span>
